...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	switch table {
	case coffeeshop.Table:
		query := c.Coffeeshop.Query().
			Where(coffeeshop.ID(id))
		query, err := query.CollectFields(ctx, "Coffeeshop")
		if err != nil {
			return nil, err
		}
